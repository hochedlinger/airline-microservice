    ...
    public class RabbitMqClient : IMessageBusClient
    {
        ...
        public RabbitMqClient(IConfiguration conf, ILogger<RabbitMqClient> logger)
        {
            ...
            try {
                ...
                _channel.ExchangeDeclare(exchange: "bookings", type: ExchangeType.Fanout);
        ...
        public void Publish(BookingPublishDTO bookingPublishDTO)
        {
            ...
            var msg = JsonSerializer.Serialize(bookingPublishDTO);
            var body = Encoding.UTF8.GetBytes(msg);

            _channel.BasicPublish(exchange: "bookings", routingKey: "", basicProperties: null, body: body );
